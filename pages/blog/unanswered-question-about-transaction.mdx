...
Tetapi saya coba cek di database, data dengan account id yang dikirimkan oleh mobile sudah betul.
Dari situ saya menyimpulkan, ada kemungkinan fungsi rollback transaksi berhasil dilakukan.
...
Untuk menjawab pertanyaan tersebut mengkin akan saya cari jawabannya lain waktu.
Saat ini akan saya masukkan ke daftar riset & analisis saya terlebih dahulu.
Lebih baik yang saya lakukan adalah membetulkan fungsi delete terlebih dahulu.
